...
source_url: "https://go.dev/wiki/TableDrivenTests"
source_path: "sources/raw/external/go-dev-wiki-tabledriventests-39d18d6ccb.html"
license_ref: ""
---
...
Here is a good example from the testing code for the `fmt` package ( https://pkg.go.dev/fmt/ <https://pkg.go.dev/fmt/> ):
...
In the previous example, tests cases were stored in a slice of structs. They can be stored in a map as well and there are several advantages to doing it this way.
...
Parallelizing table tests is simple, but requires precision to avoid bugs. Please note closely the three changes below, especially the re-declaration of `test`
...
- https://go.dev/doc/faq#assertions <https://go.dev/doc/faq#assertions>
